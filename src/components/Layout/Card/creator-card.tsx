    ...
    <>
            <Link href={link} className="flex items-center px-4 py-2  dark:hover:bg-gray-600 dark:hover:text-white">
                <div className="relative  transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110  duration-400">
                  ...
                  <div className="absolute bottom-0 background-gradient rounded-lg  w-full h-64 text-white font-family-jakarta md:text-xl lg:text-3xl ">
                    <div className="absolute bottom-1">
                      <div className="flex">
                    <Image src={avatar} width={36} height={36} className=" mr-2 rounded-full ml-4 " alt={"avatar"} />
                    <span className=" bottom-2  text-lg"> {name}</span>
                    </div>
                    </div>
                  </div>
                </div>
