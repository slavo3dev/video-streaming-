        ...
        <div>
            <div className= "md:flex xl:flex 2xl:flex lg:flex mt-20 mb-10 ">
                ...
                <div className="mt-12 sm:ml-8 ">
                    ...
                    <Link className="bg-sky-500 hover:bg-blue-700 text-white font-bold flex space-x-2 justify-center py-1 px-4 rounded-full w-44 active:bg-blue-800"href={"#!"}>Subscribe</Link></div>
            </div>
